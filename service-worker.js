const CACHE_NAME = 'agis-finance-v27-5-4-milestone-safe-v274-base';
...
const APP_SHELL = [
  ...
  './v25-3-2-ui-polish.css', './v25-5-17-easter-egg.css', './v25-5-17-easter-egg.js', './cat-idle-strip.png', './cat-walk-strip.png', './cat-run-strip.png', './cat-sleep-strip.png', './cat-pet-strip.png', './mouse-run-strip.png', './v25-3-3-financial-plan.js?v=27.2.0', './v25-3-3-financial-plan.css', './v25-3-4-balance-wallet.css', './v25-3-5-balance-savings.css', './v25-3-6-health-balance.css', './v25-3-10-health-engine.js', './v25-3-10-health-engine.css', './v26-decision-lab.js?v=27.2.0', './v26-decision-lab.css', './v27-tracking.js?v=27.5.4-safe', './v27-tracking.css?v=27.5.4-safe', './v27-safe-bridge.js?v=27.5.4-safe',
  './icon-192.png',
  './icon-512.png'
];
