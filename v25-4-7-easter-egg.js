      ...
      <div class="cat-lounge" role="dialog" aria-modal="true" aria-label="Cat Lounge">
        <div class="cat-lounge-head">
          <div>
            ...
            <div class="cat-lounge-sub">Meong sekarang bukan emoji geser lagi — badannya benar-benar dianimasikan saat jalan, lari, tidur, dan dipat-pat.</div>
          </div>
        ...
        <div class="cat-scene" id="catScene">
          ...
          <button class="cat-avatar" id="catPet" aria-label="Pat pat kucing" title="Pat pat kucing">
            <span class="cat-sprite" aria-hidden="true">
              <span class="cat-shadow"></span>
              <span class="cat-tail"></span>
              <span class="cat-leg cat-leg-back-a"></span>
              <span class="cat-leg cat-leg-back-b"></span>
              <span class="cat-body"></span>
              <span class="cat-chest"></span>
              <span class="cat-leg cat-leg-front-a"></span>
              <span class="cat-leg cat-leg-front-b"></span>
              <span class="cat-head">
                ...
                <span class="cat-face">
                  ...
                  <span class="cat-whisker cat-whisker-a"></span>
                  <span class="cat-whisker cat-whisker-b"></span>
                </span>
              </span>
            </span>
          </button>
          <button class="mouse-avatar hidden" id="catMouse" aria-label="Tikus kecil" title="Tikus kecil">
            <span class="mouse-sprite" aria-hidden="true"><span class="mouse-tail"></span><span class="mouse-ear mouse-ear-a"></span><span class="mouse-ear mouse-ear-b"></span><span class="mouse-body"></span><span class="mouse-eye"></span></span>
          </button>
        </div>
        ...
        <div class="cat-tip">Tip: tap kepala/badan kucing buat <strong>pat pat</strong>. Kakinya bergerak saat jalan, lari lebih cepat saat ngejar tikus, ekornya ikut hidup, dan dia bisa ketiduran sendiri.</div>
      </div>`;
