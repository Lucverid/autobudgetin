...
test('patched scripts bypass old cache URLs and are precached for offline use', () => {
  ...
  assert.equal(shell.CACHE_NAME, 'agis-finance-v27-5-4-integrated-stable');
  for (const url of ['./v25-3-3-financial-plan.js?v=26.0.1', './v26-decision-lab.js?v=26.0.1', './v27-tracking.js?v=27.5.4', './v26-feature-switcher.js?v=27.5.4', './v27-safe-bridge.js?v=27.5.4']) {
