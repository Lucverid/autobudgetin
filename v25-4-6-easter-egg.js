  ...
  function build(){
    ...
    el.innerHTML = `
      <div class="cat-lounge" role="dialog" aria-modal="true" aria-label="Cat Lounge">
        ...
        <div class="cat-tip">Tip: tap kucing buat <strong>pat pat</strong>. Kalau kamu tinggal sebentar, dia bisa ketiduran sendiri. Hujan malam bisa dinyalakan dari toolbar.</div>
      </div>`;
