/**
 * Agis Finance v27.5.4 SAFE — Google Apps Script backend (compatible)
...
function testTelegramFromSheet(){sendTelegram_('✅ Agis Finance v27.5.4 SAFE backend aktif. Tracking penjualan, milestone bisnis, cicilan, dan notifikasi keuangan siap.');SpreadsheetApp.getUi().alert('Pesan tes dikirim.');}
